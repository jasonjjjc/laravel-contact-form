<div id="container">
      ...
      <header id="header">
        <div id="header-top">
          <div id="main-nav">
            <a href="#" id="title"
              ><img alt="netmatters logo" src="./assets/netmatters-logo.png"
            /></a>
            <div id="support">
              <a href="#"
                ><svg
                ...
                >
                  <title>mouse</title>
                  <path
                    d="M11.016 1.078v7.922h-7.031q0-3.047 2.039-5.297t4.992-2.625zM3.984 15v-3.984h16.031v3.984q0 3.281-2.367 5.648t-5.648 2.367-5.648-2.367-2.367-5.648zM12.984 1.078q2.953 0.375 4.992 2.625t2.039 5.297h-7.031v-7.922z"
                  ></path>
                </svg>
                <h3>SUPPORT</h3>
              </a>
        ...
        <div id="header-bottom">
          <div class="nav-item" id="bespoke">
            <a href="#" id="bespoke-nav-button"
              ><svg
                class="fill-current text-[#67809F]"
                height="23"
                version="1.1"
                viewbox="0 0 32 32"
                width="23"
              ...
              <div class="dropdown-menu">
                ...
                <div class="dropdown-menu-table">
                  <div class="dropdown-menu-table-row">
                    <a class="dropdown-menu-table-row-box"
                      ><svg
                        height="28"
                        version="1.1"
                        viewbox="0 0 30 28"
                  ...
                  <div class="dropdown-menu-table-row">
                    ...
                    <a class="dropdown-menu-table-row-box"
                      ...
                      >
                        ...
                        <path
                          d="M31.998 24h-24.006v4l-7.992-6 7.992-6v4h24.006zM0 12h23.998v4l8-6-8-6v4h-23.998z"
                        ></path>
                      </svg>
                  ...
                  <div class="dropdown-menu-table-row">
                    <a class="dropdown-menu-table-row-box"
                      ...
                      >
                        <title>cloud</title>
                        <path
                          d="M30 18c0 3.313-2.688 6-6 6h-17c-3.859 0-7-3.141-7-7 0-2.797 1.656-5.219 4.031-6.328-0.016-0.219-0.031-0.453-0.031-0.672 0-4.422 3.578-8 8-8 3.344 0 6.203 2.047 7.406 4.969 0.688-0.609 1.594-0.969 2.594-0.969 2.203 0 4 1.797 4 4 0 0.797-0.234 1.531-0.641 2.156 2.656 0.625 4.641 3 4.641 5.844z"
                        ></path>
                      </svg>
                    ...
                    <a class="dropdown-menu-table-row-box"
                      ...
                      >
                        ...
                        <path
                          d="M20 14.5c0-0.281-0.219-0.5-0.5-0.5h-3.5v-5.5c0-0.266-0.234-0.5-0.5-0.5h-3c-0.266 0-0.5 0.234-0.5 0.5v5.5h-3.5c-0.281 0-0.5 0.234-0.5 0.5 0 0.125 0.047 0.266 0.141 0.359l5.5 5.5c0.094 0.094 0.219 0.141 0.359 0.141 0.125 0 0.266-0.047 0.359-0.141l5.484-5.484c0.094-0.109 0.156-0.234 0.156-0.375zM30 18c0 3.313-2.688 6-6 6h-17c-3.859 0-7-3.141-7-7 0-2.719 1.578-5.187 4.031-6.328-0.016-0.234-0.031-0.453-0.031-0.672 0-4.422 3.578-8 8-8 3.25 0 6.172 1.969 7.406 4.969 0.719-0.625 1.641-0.969 2.594-0.969 2.203 0 4 1.797 4 4 0 0.766-0.219 1.516-0.641 2.156 2.719 0.641 4.641 3.063 4.641 5.844z"
                        ></path>
                      </svg>
          ...
          <div class="nav-item" id="it-support">
            <a href="#" id="it-support-nav-button"
              ><svg
                height="23"
                version="1.1"
                viewbox="0 0 32 32"
                  ...
                  <div class="dropdown-menu-table-row">
                    <a class="dropdown-menu-table-row-box"
                      ...
                      >
                        <title>school</title>
                        <path
                          d="M12 3l11.016 6v8.016h-2.016v-6.938l-9 4.922-11.016-6zM5.016 13.172l6.984 3.844 6.984-3.844v4.031l-6.984 3.797-6.984-3.797v-4.031z"
                        ></path>
                      </svg>
                    ...
                    <a class="dropdown-menu-table-row-box"
                      ...
                      >
                        ...
                        <path
                          d="M21 13v5c0 0.276-0.111 0.525-0.293 0.707s-0.431 0.293-0.707 0.293h-16c-0.276 0-0.525-0.111-0.707-0.293s-0.293-0.431-0.293-0.707v-5zM6.344 5.558c0.066-0.131 0.16-0.246 0.272-0.337 0.172-0.139 0.387-0.221 0.624-0.221h9.513c0.15 0.001 0.295 0.034 0.426 0.094 0.201 0.092 0.37 0.249 0.477 0.464l2.725 5.442h-16.762zM4.556 4.662l-3.441 6.872c-0.031 0.059-0.056 0.121-0.075 0.187-0.028 0.094-0.041 0.188-0.040 0.279v6c0 0.828 0.337 1.58 0.879 2.121s1.293 0.879 2.121 0.879h16c0.828 0 1.58-0.337 2.121-0.879s0.879-1.293 0.879-2.121v-6c0-0.151-0.033-0.293-0.091-0.417-0.005-0.010-0.010-0.021-0.015-0.031l-0.009-0.018-3.441-6.872c-0.315-0.634-0.829-1.111-1.433-1.387-0.388-0.177-0.812-0.272-1.244-0.275h-9.527c-0.711 0-1.367 0.249-1.883 0.667-0.331 0.268-0.605 0.606-0.801 0.995zM6 17c0.552 0 1-0.448 1-1s-0.448-1-1-1-1 0.448-1 1 0.448 1 1 1zM10 17c0.552 0 1-0.448 1-1s-0.448-1-1-1-1 0.448-1 1 0.448 1 1 1z"
                        ></path>
                      </svg>
          ...
          <div class="nav-item" id="digital-marketing">
            <a href="#" id="digital-marketing-nav-button"
              ><svg
                height="23"
                version="1.1"
                viewbox="0 0 32 32"
          ...
          <div class="nav-item" id="telecoms-services">
            <a href="#" id="telecoms-services-nav-button"
              ><svg
                height="23"
                version="1.1"
                viewbox="0 0 24 24"
          ...
          <div class="nav-item" id="web-design">
            <a href="#" id="web-design-nav-button"
              ><svg
                height="23"
                version="1.1"
                viewbox="0 0 40 32"
                  ...
                  <div class="dropdown-menu-table-row">
                    ...
                    <a class="dropdown-menu-table-row-box"
                      ...
                      >
                        <title>monitor</title>
                        <path
                          d="M20.016 3h-16.031q-0.797 0-1.383 0.586t-0.586 1.43v10.969q0 0.844 0.586 1.43t1.383 0.586h3l-0.984 0.984v2.016h12v-2.016l-0.984-0.984h3q0.797 0 1.383-0.586t0.586-1.43v-10.969q0-0.844-0.586-1.43t-1.383-0.586zM20.016 15.984h-16.031v-10.969h16.031v10.969z"
                        ></path>
                      </svg>
          ...
          <div class="nav-item" id="cyber-security">
            <a href="#" id="cyber-security-nav-button"
              ><svg
                height="23"
                viewbox="0 0 24 24"
                width="23"
                  ...
                  <div class="dropdown-menu-table-row">
                    ...
                    <a class="dropdown-menu-table-row-box"
                      ...
                      >
                        ...
                        <path
                          d="M12 0.984l9 4.031v6q0 4.172-2.578 7.617t-6.422 4.383q-3.844-0.938-6.422-4.383t-2.578-7.617v-6zM12 12v8.953q2.766-0.891 4.688-3.352t2.297-5.602h-6.984zM12 12v-8.813l-6.984 3.094v5.719h6.984z"
                        ></path>
                      </svg>
          ...
          <div class="nav-item" id="developer-course">
            <a href="#" id="developer-course-nav-button"
              ><svg
                height="23"
                viewbox="0 0 24 24"
                width="23"
      ...
      <main id="main">
        ...
        <div id="services">
          ...
          <div class="accreditations-slider">
            <img
              alt="future 50 logo"
              src="./assets/accreditations/future-50.jpeg"
            />
            <img
              alt="google partner logo"
              src="./assets/accreditations/google-partner.jpeg"
            />
            <img
              alt="investing in future growth logo"
              src="./assets/accreditations/investing-in-future-growth.jpeg"
            />
            <img
              alt="iso 27001 logo"
              src="./assets/accreditations/iso_27001.jpeg"
            />
            <img
              alt="living wage logo"
              src="./assets/accreditations/living_wage.png"
            />
            <img
              alt="norfolk carbon charter logo"
              src="./assets/accreditations/norfolk-carbon-charter.jpeg"
            />
            <img
              alt="norfolk prohelp logo"
              src="./assets/accreditations/norfolk_prohelp.png"
            />
            <img alt="ppc logo" src="./assets/accreditations/PPC_logo.jpeg" />
            <img
              alt="princess royal training logo"
              src="./assets/accreditations/princess-royal-training.jpeg"
            />
            <img alt="qms logo" src="./assets/accreditations/qms.jpeg" />
            <img
              alt="skills of tomorrow logo"
              src="./assets/accreditations/skills-of-tomorrow.jpeg"
            />
          </div>
        </div>
            ...
            <div id="company-reviews">
              ...
              <div id="company-reviews-quote">
                ...
                <p id="company-reviews-quote-author">
                  <span id="company-reviews-quote-author-name"
                    >Eleanor Bishop, Head of Marketing -</span
                  >
                  <span id="company-reviews-quote-author-organisation"
              ...
              <div id="company-reviews-links">
                <a href="#" id="company-reviews-links-google"
                  >GOOGLE REVIEWS
                  <svg
                    height="24"
                    version="1.1"
                ...
                <a href="#" id="company-reviews-links-trustpilot"
                  >TRUSTPILOT REVIEWS
                  <svg
                    height="24"
                    version="1.1"
            ...
            <div id="latest-news-cards">
              <a href="#" id="latest-news-cards-1">
                <div id="latest-news-cards-1-upper">
                  ...
                  <img
                    alt="business development account manager thumbnail"
                    id="latest-news-cards-1-upper-thumb"
                    src="./assets/thumbnails/business-development-account-zUub.webp"
                  />
                </div>
                <div id="latest-news-cards-1-lower">
                  ...
                  <div id="latest-news-cards-1-lower-author">
                    <div id="latest-news-cards-1-lower-author-img">
                      <img
                        alt="user picture"
                        src="./assets/thumbnails/elliott-peacock-w8vu.webp"
                      />
                    </div>
              ...
              <a href="#" id="latest-news-cards-2">
                <div id="latest-news-cards-2-upper">
                  ...
                  <img
                    alt="web project manager thumbnail"
                    id="latest-news-cards-2-upper-thumb"
                    src="./assets/thumbnails/web-project-manager-FeSd.webp"
                  />
                </div>
                <div id="latest-news-cards-2-lower">
                  ...
                  <div id="latest-news-cards-2-lower-author">
                    <div id="latest-news-cards-2-lower-author-img">
                      <img
                        alt="user picture"
                        src="./assets/thumbnails/tom-lancaster-61K1.webp"
                      />
                    </div>
              ...
              <a href="#" id="latest-news-cards-3">
                <div id="latest-news-cards-3-upper">
                  ...
                  <img
                    alt="digital marketing executive thumbnail"
                    id="latest-news-cards-3-upper-thumb"
                    src="./assets/thumbnails/digital-marketing-executive-UmWA.webp"
                  />
                </div>
                <div id="latest-news-cards-3-lower">
                  ...
                  <div id="latest-news-cards-3-lower-author">
                    <div id="latest-news-cards-3-lower-author-img">
                      <img
                        alt="user picture"
                        src="./assets/thumbnails/james-palmer-1KKg.webp"
                      />
                    </div>
            ...
            <div class="latest-clients-list">
              <div>
                ...
                <img
                  ...
                  src="./assets/clients/ashcroftlogo_landscape_goldblack_DP60P-small.png"
                />
                <div class="slick-slide-description">
                  ...
                  <a
                    class="slick-slide-description-link purple"
                    href="#"
                    target="_blank"
                    >View our case study</a
                  >
                </div>
              </div>
              <div>
                ...
                <img
                  alt="beat logo"
                  class="slick-slide-image"
                  src="./assets/clients/beat_logo.png"
                />
                <div class="slick-slide-description">
              ...
              <div>
                ...
                <img
                  alt="black swan logo"
                  class="slick-slide-image"
                  src="./assets/clients/black_swan_logo.png"
                />
                <div class="slick-slide-description">
                  <h3 class="slick-slide-description-title">
                  ...
                  <a
                    class="slick-slide-description-link grey"
                    href="#"
                    target="_blank"
                    >View our case study</a
                  >
              ...
              <div>
                ...
                <img
                  ...
                  class="slick-slide-image"
                  src="./assets/clients/crane_logo.png"
                />
                <div class="slick-slide-description">
                  <h3 class="slick-slide-description-title">
              ...
              <div>
                <!-- Slick slide -->
                <img
                  alt="girl guides anglia logo"
                  class="slick-slide-image"
                  src="./assets/clients/girl_guides_anglia_logo.png"
                />
                <div class="slick-slide-description">
                  <h3 class="slick-slide-description-title">
                    Girl Guiding Anglia
                  ...
                  <a
                    class="slick-slide-description-link blue"
                    href="#"
                    target="_blank"
                    >View our case study</a
                  >
              ...
              <div>
                <!-- Slick slide -->
                <img
                  alt="girls day school trust logo"
                  class="slick-slide-image"
                  src="./assets/clients/girls_day_school_trust_logob.png"
                />
                <div class="slick-slide-description">
                  ...
                  <a
                    class="slick-slide-description-link green"
                    href="#"
                    target="_blank"
                    >View our case study</a
                  >
              ...
              <div>
                ...
                <img
                  ...
                  class="slick-slide-image"
                  src="./assets/clients/howespercivallogo.png"
                />
                <div class="slick-slide-description">
              ...
              <div>
                ...
                <img
                  ...
                  class="slick-slide-image"
                  src="./assets/clients/onetravellerlogo_white_figuire.png"
                />
                <div class="slick-slide-description">
              ...
              <div>
                ...
                <img
                  alt="searles logo"
                  class="slick-slide-image"
                  src="./assets/clients/searles_logo.jpeg"
                />
                <div class="slick-slide-description">
                  <h3 class="slick-slide-description-title">
              ...
              <div>
                ...
                <img
                  ...
                  class="slick-slide-image"
                  src="./assets/clients/survey_solutions_logo.png"
                />
                <div class="slick-slide-description">
                  <h3 class="slick-slide-description-title">
                    Survey Solutions
              ...
              <div>
                ...
                <img
                  alt="sweetzy logo"
                  class="slick-slide-image"
                  src="./assets/clients/sweetzy_logo.png"
                />
                <div class="slick-slide-description">
              ...
              <div>
                ...
                <img
                  alt="xupes logo"
                  class="slick-slide-image"
                  src="./assets/clients/xupes_logo.png"
                />
                <div class="slick-slide-description">
              ...
              <div>
                ...
                <img
                  alt="busseys logo"
                  class="slick-slide-image"
                  src="./assets/clients/busseys.png"
                />
                <div class="slick-slide-description">
            ...
            <form id="signup-form" name="signup-form">
              <div id="signup-form-inputs">
                <div id="signup-form-inputs-name">
                  <label
                    for="signup-form-inputs-name-input"
                    id="signup-form-inputs-name-label"
                    >Your Name<span class="asterisk">*</span></label
                  >
                  <input
                    id="signup-form-inputs-name-input"
                    required=""
                    type="text"
                  />
                </div>
                <div id="signup-form-inputs-email">
                  <label
                    for="signup-form-inputs-email-input"
                    id="signup-form-inputs-email-label"
                    >Your Email<span class="asterisk">*</span></label
                  >
                  <input
                    id="signup-form-inputs-email-input"
                    required=""
                    type="text"
                  />
                </div>
              ...
              <div id="signup-form-marketing">
                <input
                  id="signup-form-marketing-checkbox"
                  type="checkbox"
                  value="marketing-preference"
                />
                <label
                  for="signup-form-marketing-checkbox"
                  id="signup-form-marketing-label"
            ...
            <div id="nav">
              <div id="nav-social">
                <img
                  alt="netmatters logo"
                  id="nav-social-icon"
                  src="./assets/nm-logo-white-med.png"
                />
